def circuit_to_tikz_string(size, circuit):
    ...
    circuit_length = len(circuit) - 1

    line_start = drawing_offset - line_protrusion
    line_end = circuit_length + line_protrusion
...
#tikz = circuit_to_tikz_file(size, circuit, "oi")
